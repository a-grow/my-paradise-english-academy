  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-paradise-purple/90 to-paradise-sky/90 backdrop-blur-md shadow-lg">
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <a href="/portal" className="nav-link" style={{background:"linear-gradient(135deg,hsl(var(--paradise-coral)),hsl(var(--paradise-pink)))",color:"white",padding:"0.4rem 1.1rem",borderRadius:"999px",fontWeight:"bold"}}>Student Login</a>
