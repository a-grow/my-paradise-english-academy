...
const ArrowShoot = ({unit,diff,onBack,onClaim,claimState}:{unit:UnitData;diff:Diff;onBack:()=>void;onClaim?:()=>void;claimState?:"available"|"claimed"|"capped"}) => {
  ...
  return (
    <div style={{width:"100%",height:"100vh",position:"relative",overflow:"hidden",cursor:"crosshair",paddingBottom:36,background:"linear-gradient(180deg,#4fc3f7 0%,#81d4fa 30%,#b3e5fc 55%,#c8e6c9 75%,#a5d6a7 100%)"}}>
      <style>{`
