  ...
  return (
    <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "0.75rem" }}>
      {creatures.map((c, i) => {
        ...
        const col = COLS[i];
        return (
          <div key={i} style={{ position: "relative", borderRadius: "1.25rem", background: `${col.bg}${unlocked ? "33" : "18"}`, border: `2px solid ${col.border}`, padding: "0.85rem 0.5rem", boxShadow: `0 0 ${unlocked ? 20 : 10}px ${col.glow}`, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", transition: "all 0.3s" }}>
            {unlocked ? (
              <>
